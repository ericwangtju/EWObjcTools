//
//  NSAttributedString+EWObjcSugar.m
//  108-Additions
//
...
#import "NSAttributedString+EWSugar.h"

@implementation NSAttributedString (EWSugar)
+ (instancetype)ew_imageTextWithImage:(UIImage *)image imageWH:(CGFloat)imageWH title:(NSString *)title fontSize:(CGFloat)fontSize titleColor:(UIColor *)titleColor spacing:(CGFloat)spacing {
