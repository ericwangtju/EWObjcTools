...
CGContextRef _Nullable EWCGContextCreateARGBBitmapContext(CGSize size, BOOL opaque, CGFloat scale);

/// Create a `DeviceGray` Bitmap context. Returns NULL if an error occurs.
CGContextRef _Nullable EWCGContextCreateGrayBitmapContext(CGSize size, CGFloat scale);



/// Get main screen's scale.
CGFloat EWScreenScale(void);

/// Get main screen's size. Height is always larger than width.
CGSize EWScreenSize(void);
 ...
 */
CGAffineTransform EWCGAffineTransformGetFromPoints(CGPoint before[_Nullable 3], CGPoint after[_Nullable 3]);

/// Get the transform which can converts a point from the coordinate system of a given view to another.
CGAffineTransform EWCGAffineTransformGetFromViews(UIView *from, UIView *to);
...
UIViewContentMode EWCAGravityToUIViewContentMode(NSString *gravity);

/// Convert UIViewContentMode to CALayer's gravity string.
NSString *EWUIViewContentModeToCAGravity(UIViewContentMode contentMode);
 ...
 */
CGRect EWCGRectFitWithContentMode(CGRect rect, CGSize size, UIViewContentMode mode);
...
// main screen's scale
#ifndef kScreenScale
#define kScreenScale EWScreenScale()
#endif

// main screen's size (portrait)
#ifndef kScreenSize
#define kScreenSize EWScreenSize()
#endif

// main screen's width (portrait)
#ifndef kScreenWidth
#define kScreenWidth EWScreenSize().width
#endif

// main screen's height (portrait)
#ifndef kScreenHeight
#define kScreenHeight EWScreenSize().height
#endif
