 ...
 */
@interface UIImage (EWSugar)

- (UIImage *_Nullable)ew_drawRactWithRoundCornorWithRadius:(CGFloat)radius size:(CGSize)size backColor:(UIColor *_Nullable)backColor lineWidth:(CGFloat)lineWidth lineColor:(UIColor *_Nullable)lineColor;
