...
#import "NSObject+EWSugarForRuntime.h"
#import <objc/runtime.h>

@implementation NSObject (EWSugarForRuntime)
+ (NSArray *)ew_objectsWithArray:(NSArray *)array {
    ...
    // 0. 获得属性数组
    NSArray *list = [self ew_propertiesList];
...
void *propertiesKey = "cn.hou_tech.propertiesList";
...
void *ivarsKey = "cn.hou_tech.ivarsList";
