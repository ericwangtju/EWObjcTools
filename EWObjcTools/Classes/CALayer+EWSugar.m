...
#import "CALayer+EWSugar.h"
#import "EWCategoriesMacro.h"
#import "EWCGUtilities.h"

EWSYNTH_DUMMY_CLASS(CALayer_EWSugar)
@implementation CALayer (EWSugar)
...
- (UIViewContentMode)contentMode {
    return EWCAGravityToUIViewContentMode(self.contentsGravity);
}

- (void)setContentMode:(UIViewContentMode)contentMode {
    self.contentsGravity = EWUIViewContentModeToCAGravity(contentMode);
}
